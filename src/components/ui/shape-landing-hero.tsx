...
function HeroGeometric({
  badge = "AI Fraud Shield",
  title1 = "Real-time Fraud Monitoring",
  title2 = "Bank-grade AI Protection",
}: {
  badge?: string;
  title1?: string;
  title2?: string;
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            animate="visible"
          >
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-semibold mb-6 md:mb-8 tracking-tight">
          ...
          >
            <p className="text-base sm:text-lg md:text-xl text-white/60 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Real-time intelligent transaction monitoring powered by explainable
              AI, anomaly detection, and bank-grade security controls.
            </p>
          </motion.div>
        </div>
      </div>
